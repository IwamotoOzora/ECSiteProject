...
<body>
  ...
  <h1>商品変更確認画面</h1>
      <div class="register">登録商品一覧</div>
       <form action="UpdateDisicionServlet" method="post">
        <table class="update_item">
          <tr>
        ...
        <table>
          ...
          <input type="submit" name="back" value="戻る" formaction="GoToAdministrationUpdateServlet"></input>
       </form>
